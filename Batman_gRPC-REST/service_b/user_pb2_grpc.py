...
class UserServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetMovie = channel.unary_unary(
                '/user.UserService/GetMovie',
                request_serializer=user__pb2.MovieRequest.SerializeToString,
...
def add_UserServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetMovie': grpc.unary_unary_rpc_method_handler(
                    servicer.GetMovie,
                    request_deserializer=user__pb2.MovieRequest.FromString,
...
class UserService(object):
    ...
    def GetMovie(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/user.UserService/GetMovie',
            user__pb2.MovieRequest.SerializeToString,
